	...
	method = {
		...
		map: {
			...
			add_train_lines: function(geojson){
				...
				jQuery('#next_arrival_start, #next_arrival_end').autocomplete({
					source: _rail_stops,
					minLength: 0
				}).autocomplete( "widget" ).addClass( "scheduleAutoComplete" );
			},
